...
function USNMegaNav($scope, angularHelper, localizationService, entityResource, iconHelper, editorService, $http, assetsService, notificationsService, $routeParams) {
...
var module = angular.module("umbraco").controller("USN.MegaNav.Controller", USNMegaNav);

module.directive("mnConfirmClick", ["angularHelper",
        ...
        return {
            link: function (scope, element, attr) {
                element.bind('click', function (e) {
                    ...
                    var currentForm = angularHelper.getCurrentForm(scope);
                    var msg = attr.mnConfirmClick || "Are you sure?"
